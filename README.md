...
## FluxCD
A CI/CD solution that allows code changes to be applied to the cluster, once applied to the main branch/trunk.  This is the base of the GitOps which bootstraps the workflow by cluster (production, staging, etc...), and this is why it is installed in its own clusters directory.
